...
const workdata: workdata[] = [
    ...
    },
    {
        ...
        heading: 'Producto garantido',
        subheading: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry and this',
        hiddenpara: 'standard dummy text ever since the 1500s, when an unknownprinter took a galley of type and scrambled it to make a type specimen book. It has survived...',
    },
    {
        imgSrc: '/images/Work/icon-three.svg',
        heading: 'Servicio Post Venta',
        subheading: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry and this',
        hiddenpara: 'standard dummy text ever since the 1500s, when an unknownprinter took a galley of type and scrambled it to make a type specimen book. It has survived...',
    },
        ...
        <div>
            <div className='mx-auto max-w-7xl mt-16 px-6 mb-20 relative'>
                ...
                <div className='text-center mb-14'>
                    <h3 className='text-offwhite text-3xl md:text-5xl font-bold mb-3'>Porqué elegirnos</h3>
                    <p className='text-bluish md:text-lg font-normal leading-8'>Tenemos el precio mas bajo del mercado, según la potencia instalada por Metro Cuadrado. <br /> Conocemos las necesidades de calefacción para cada tipo de construcción.</p>
                </div>
